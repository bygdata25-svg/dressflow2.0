...
export const DEFAULT_CUSTOMER_FIELDS: FieldConfig[] = [
  {
    field_name: "code",
    label: "customers:form.fields.code",
    field_type: "text",
    visible: true,
    required: false,
    editable: true,
    ...
    help_text: null,
    validation_rules: { max_length: 40 },
    ui_props: { placeholder: "customers:form.placeholders.code" },
  },
  {
    field_name: "first_name",
    label: "customers:form.fields.first_name",
    field_type: "text",
    visible: true,
    required: true,
    editable: true,
    ...
    help_text: null,
    validation_rules: { min_length: 2, max_length: 120 },
    ui_props: { placeholder: "customers:form.placeholders.first_name" },
  },
  {
    field_name: "last_name",
    label: "customers:form.fields.last_name",
    field_type: "text",
    visible: true,
    required: true,
    editable: true,
    ...
    help_text: null,
    validation_rules: { min_length: 2, max_length: 120 },
    ui_props: { placeholder: "customers:form.placeholders.last_name" },
  },
  {
    field_name: "tax_id",
    label: "customers:form.fields.tax_id",
    field_type: "text",
    visible: true,
    required: true,
    editable: true,
    ...
    ui_props: { placeholder: "customers:form.placeholders.tax_id" },
  },
  {
    field_name: "full_name",
    label: "customers:form.fields.full_name",
    field_type: "virtual_text",
    visible: true,
    required: false,
    editable: false,
    ...
    form_visible: false,
    order_index: 5,
    help_text: "customers:form.help.full_name",
    validation_rules: null,
    ui_props: null,
  },
  {
    field_name: "email",
    label: "customers:form.fields.email",
    field_type: "email",
    visible: true,
    required: false,
    editable: true,
    ...
    ui_props: { placeholder: "customers:form.placeholders.email" },
  },
  {
    field_name: "phone",
    label: "customers:form.fields.phone",
    field_type: "text",
    visible: true,
    required: false,
    editable: true,
    ...
    help_text: null,
    validation_rules: { max_length: 40 },
    ui_props: { placeholder: "customers:form.placeholders.phone" },
  },
  {
    field_name: "notes",
    label: "customers:form.fields.notes",
    field_type: "textarea",
    visible: true,
    required: false,
    editable: true,
    ...
    help_text: null,
    validation_rules: { max_length: 2000 },
    ui_props: { placeholder: "customers:form.placeholders.notes" },
  },
];
